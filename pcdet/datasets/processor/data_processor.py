    ...
    def sample_points(self, data_dict=None, config=None):
        ...
        if num_points < len(radar_points):
            ...
            if num_points > len(radar_far_idxs_choice):
                radar_near_idxs_choice = np.random.choice(radar_near_idxs, radar_num_points - len(radar_far_idxs_choice), replace=False)
                ...
                radar_choice = np.random.choice(radar_choice, radar_num_points, replace=False)
