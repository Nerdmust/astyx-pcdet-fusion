...
class PointPillarScatter(nn.Module):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        for batch_idx in range(lidar_batch_size):
            ...
            lidar_batch_mask = lidar_coords[:, 0] == batch_idx
        ...
        for batch_idx in range(radar_batch_size):
            ...
            radar_batch_mask = radar_coords[:, 0] == batch_idx
        ...
        # batch_dict['spatial_features'] = torch.cat((lidar_batch_spatial_features, radar_batch_spatial_features), 2)
        return batch_dict
